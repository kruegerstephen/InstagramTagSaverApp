...
import com.example.tagsaver.utils.InstagramDialog.OAuthDialogListener;
import com.example.tagsaver.utils.Helper;
 ...
 *
 * modified and addaped for school project by
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    writer.flush();
                    String response = Helper.streamToString(urlConnection
                            .getInputStream());
